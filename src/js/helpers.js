...
function SwiperProxy($els, op) {
    $els.each(function () {
        ...
        var calcWidth = function () {
            ...
            if (op.nav) {
                //width -= $(opt.navigation.prevEl).width() + 10;
                //width -= $(opt.navigation.nextEl).width() + 10;
            }
        ...
        if (opt.nav) {
            ...
            delete opt.nav;
            $el.parent().css('padding-left', ($(opt.navigation.prevEl).width() + 10) + 'px');
            $el.parent().css('padding-right', ($(opt.navigation.nextEl).width() + 10) + 'px');
        }
